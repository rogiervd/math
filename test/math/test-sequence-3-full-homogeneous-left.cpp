...
#define BOOST_TEST_MODULE test_sequence_full_homogeneous_left
#include "utility/test/boost_unit_test.hpp"

#include "sequence-tests-slow.hpp"

BOOST_AUTO_TEST_SUITE (test_suite_sequence_full_homogeneous_left)

BOOST_AUTO_TEST_CASE (test_sequence_left) {
    test_sequence_homogeneous <math::left>();
}
